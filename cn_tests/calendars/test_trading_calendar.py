...
from zipline.utils.calendars.trading_calendar import days_at_time,TradingCalendar
...
class DefaultsTestCase(TestCase):
    def test_default_calendars(self):
        ...
        self.assertTrue(calendar.name == 'SZSH', '默认为"SZSH"')
...
class DaysAtTimeTestCase(TestCase):
    @parameterized.expand([
        # SZSH standard day
        (
            '2016-07-19', 0, time(9, 31), timezone('Asia/Shanghai'),
            '2016-07-19 9:31',
        ),
        # NYSE standard day
        (
