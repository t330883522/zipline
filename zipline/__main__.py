...
@click.option(
    '-bm',
    '--bm_symbol',
    default='000300',  # 数据自2002-01-07开始
    show_default=True,
    help='Symbol for the benchmark index to load, use for the simulation.',
)
@click.option(
    '--bundle-timestamp',
    type=Timestamp(),
...
@click.option(
    ...
    default='SZSH',
    help="The calendar you want to use e.g. LSE. SZSH is the default."
)
@click.option(
